...
class AlignTextView @JvmOverloads constructor(
    ...
    init {
        ...
        text = attr.getString(R.styleable.AlignTextView_align_text) ?: text
        textColor = attr.getColor(R.styleable.AlignTextView_align_text_color, textColor)
        textSize = attr.getDimensionPixelSize(R.styleable.AlignTextView_align_text_size, textSize.toInt()).toFloat()
        attr.recycle()
    }
